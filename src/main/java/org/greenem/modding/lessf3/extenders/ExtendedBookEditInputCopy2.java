...
public class ExtendedBookEditInputCopy2 extends Screen {
    ...
    @Nullable
    private ExtendedBookEditInputCopy2.DisplayCache displayCache = ExtendedBookEditInputCopy2.DisplayCache.EMPTY;
    private Component pageMsg = TextComponent.EMPTY;
    private Component ownerText = null;

    public ExtendedBookEditInputCopy2() {
        super(NarratorChatListener.NO_TITLE);
//        CompoundTag compoundtag = p_98077_.getTag();
//        if (compoundtag != null) {
//            BookViewScreen.loadPages(this.pages::add);
//        }
        ...
        this.ownerText = (new TextComponent("(Text5) book.byAuthor (DELETED LOL)").withStyle(ChatFormatting.DARK_GRAY));
    }

    protected ExtendedBookEditInputCopy2(Component p_96550_) {
        super(p_96550_);
    }
    ...
    protected void init() {
        ...
        this.signButton = this.addRenderableWidget(new Button(this.width / 2 - 100, 196, 98, 20, new TextComponent("Done"), (p_98177_) -> {
//            this.isSigning = true;
            // DONE BUTTON
...
//            this.book.addTagElement("title", StringTag.valueOf(this.title.trim()));
    ...
    private void keyEnd() {
        ExtendedBookEditInputCopy2.DisplayCache ExtendedBookEditInput$displaycache = this.getDisplayCache();
        int i = this.pageEdit.getCursorPos();
...
//            this.font.drawWordWrap(FINALIZE_WARNING_LABEL, i + 36, 82, 114, 0);
            ...
            for(ExtendedBookEditInputCopy2.LineInfo ExtendedBookEditInput$lineinfo : ExtendedBookEditInput$displaycache.lines) {
    ...
    private void renderCursor(PoseStack p_98109_, ExtendedBookEditInputCopy2.Pos2i p_98110_, boolean p_98111_) {
    ...
    private ExtendedBookEditInputCopy2.Pos2i convertScreenToLocal(ExtendedBookEditInputCopy2.Pos2i p_98115_) {
        return new ExtendedBookEditInputCopy2.Pos2i(p_98115_.x - (this.width - 192) / 2 - 36, p_98115_.y - 32);
    }

    private ExtendedBookEditInputCopy2.Pos2i convertLocalToScreen(ExtendedBookEditInputCopy2.Pos2i p_98146_) {
        return new ExtendedBookEditInputCopy2.Pos2i(p_98146_.x + (this.width - 192) / 2 + 36, p_98146_.y + 32);
    }
    ...
    public boolean mouseClicked(double p_98088_, double p_98089_, int p_98090_) {
        if (super.mouseClicked(p_98088_, p_98089_, p_98090_)) {
            ...
            if (p_98090_ == 0) {
                ...
                ExtendedBookEditInputCopy2.DisplayCache ExtendedBookEditInput$displaycache = this.getDisplayCache();
                int j = ExtendedBookEditInput$displaycache.getIndexAtPosition(this.font, this.convertScreenToLocal(new ExtendedBookEditInputCopy2.Pos2i((int)p_98088_, (int)p_98089_)));
                if (j >= 0) {
    ...
    public boolean mouseDragged(double p_98092_, double p_98093_, int p_98094_, double p_98095_, double p_98096_) {
        if (super.mouseDragged(p_98092_, p_98093_, p_98094_, p_98095_, p_98096_)) {
            ...
            if (p_98094_ == 0) {
                ExtendedBookEditInputCopy2.DisplayCache ExtendedBookEditInput$displaycache = this.getDisplayCache();
                int i = ExtendedBookEditInput$displaycache.getIndexAtPosition(this.font, this.convertScreenToLocal(new ExtendedBookEditInputCopy2.Pos2i((int)p_98092_, (int)p_98093_)));
    ...
    private ExtendedBookEditInputCopy2.DisplayCache getDisplayCache() {
    ...
    private ExtendedBookEditInputCopy2.DisplayCache rebuildDisplayCache() {
        String s = this.getCurrentPageText();
        if (s.isEmpty()) {
            return ExtendedBookEditInputCopy2.DisplayCache.EMPTY;
        } else {
            int i = this.pageEdit.getCursorPos();
            int j = this.pageEdit.getSelectionPos();
            IntList intlist = new IntArrayList();
            List<ExtendedBookEditInputCopy2.LineInfo> list = Lists.newArrayList();
            ...
            stringsplitter.splitLines(s, 114, Style.EMPTY, true, (p_98132_, p_98133_, p_98134_) -> {
                ...
                int l3 = k3 * 9;
                ExtendedBookEditInputCopy2.Pos2i ExtendedBookEditInput$pos2i1 = this.convertLocalToScreen(new ExtendedBookEditInputCopy2.Pos2i(0, l3));
                intlist.add(p_98133_);
                list.add(new ExtendedBookEditInputCopy2.LineInfo(p_98132_, s3, ExtendedBookEditInput$pos2i1.x, ExtendedBookEditInput$pos2i1.y));
            });
            int[] aint = intlist.toIntArray();
            boolean flag = i == s.length();
            ExtendedBookEditInputCopy2.Pos2i ExtendedBookEditInput$pos2i;
            if (flag && mutableboolean.isTrue()) {
                ExtendedBookEditInput$pos2i = new ExtendedBookEditInputCopy2.Pos2i(0, list.size() * 9);
            } else {
                int k = findLineFromPos(aint, i);
                int l = this.font.width(s.substring(aint[k], i));
                ExtendedBookEditInput$pos2i = new ExtendedBookEditInputCopy2.Pos2i(l, k * 9);
            }
            ...
            if (i != j) {
                ...
                if (j1 == k1) {
                    ...
                    for(int j3 = j1 + 1; j3 < k1; ++j3) {
                        ...
                        list1.add(this.createSelection(new ExtendedBookEditInputCopy2.Pos2i(0, j2), new ExtendedBookEditInputCopy2.Pos2i(k2, j2 + 9)));
                    }
            ...
            return new ExtendedBookEditInputCopy2.DisplayCache(s, ExtendedBookEditInput$pos2i, flag, aint, list.toArray(new ExtendedBookEditInputCopy2.LineInfo[0]), list1.toArray(new Rect2i[0]));
        }
    }
    ...
    private Rect2i createPartialLineSelection(String p_98120_, StringSplitter p_98121_, int p_98122_, int p_98123_, int p_98124_, int p_98125_) {
        ...
        ExtendedBookEditInputCopy2.Pos2i ExtendedBookEditInput$pos2i = new ExtendedBookEditInputCopy2.Pos2i((int)p_98121_.stringWidth(s), p_98124_);
        ExtendedBookEditInputCopy2.Pos2i ExtendedBookEditInput$pos2i1 = new ExtendedBookEditInputCopy2.Pos2i((int)p_98121_.stringWidth(s1), p_98124_ + 9);
        return this.createSelection(ExtendedBookEditInput$pos2i, ExtendedBookEditInput$pos2i1);
    }

    private Rect2i createSelection(ExtendedBookEditInputCopy2.Pos2i p_98117_, ExtendedBookEditInputCopy2.Pos2i p_98118_) {
        ExtendedBookEditInputCopy2.Pos2i ExtendedBookEditInput$pos2i = this.convertLocalToScreen(p_98117_);
        ExtendedBookEditInputCopy2.Pos2i ExtendedBookEditInput$pos2i1 = this.convertLocalToScreen(p_98118_);
    ...
    static class DisplayCache {
        static final ExtendedBookEditInputCopy2.DisplayCache EMPTY = new ExtendedBookEditInputCopy2.DisplayCache("", new ExtendedBookEditInputCopy2.Pos2i(0, 0), true, new int[]{0}, new ExtendedBookEditInputCopy2.LineInfo[]{new ExtendedBookEditInputCopy2.LineInfo(Style.EMPTY, "", 0, 0)}, new Rect2i[0]);
        private final String fullText;
        final ExtendedBookEditInputCopy2.Pos2i cursor;
        final boolean cursorAtEnd;
        private final int[] lineStarts;
        final ExtendedBookEditInputCopy2.LineInfo[] lines;
        final Rect2i[] selection;

        public DisplayCache(String p_98201_, ExtendedBookEditInputCopy2.Pos2i p_98202_, boolean p_98203_, int[] p_98204_, ExtendedBookEditInputCopy2.LineInfo[] p_98205_, Rect2i[] p_98206_) {
        ...
        public int getIndexAtPosition(Font p_98214_, ExtendedBookEditInputCopy2.Pos2i p_98215_) {
            int i = p_98215_.y / 9;
            if (i < 0) {
                return 0;
                ...
                ExtendedBookEditInputCopy2.LineInfo ExtendedBookEditInput$lineinfo = this.lines[i];
        ...
        public int changeLine(int p_98211_, int p_98212_) {
            int i = ExtendedBookEditInputCopy2.findLineFromPos(this.lineStarts, p_98211_);
            int j = i + p_98212_;
            int k;
        ...
        public int findLineStart(int p_98209_) {
            int i = ExtendedBookEditInputCopy2.findLineFromPos(this.lineStarts, p_98209_);
            return this.lineStarts[i];
        }

        public int findLineEnd(int p_98219_) {
            int i = ExtendedBookEditInputCopy2.findLineFromPos(this.lineStarts, p_98219_);

...
public class ExtendedBookEditInput extends Screen {
    ...
    @Nullable
    private ExtendedBookEditInput.DisplayCache displayCache = ExtendedBookEditInput.DisplayCache.EMPTY;
    private Component pageMsg = TextComponent.EMPTY;
    private Component ownerText = null;

    public ExtendedBookEditInput() {
...
//        }
        ...
        this.ownerText = (new TextComponent("(Text5) book.byAuthor (DELETED LOL)").withStyle(ChatFormatting.WHITE));
    }

    protected ExtendedBookEditInput(Component p_96550_) {
        super(p_96550_);
    }
...
//            this.book.addTagElement("title", StringTag.valueOf(this.title.trim()));
    ...
    private void keyEnd() {
        ExtendedBookEditInput.DisplayCache ExtendedBookEditInput$displaycache = this.getDisplayCache();
        int i = this.pageEdit.getCursorPos();
...
//            this.font.drawWordWrap(FINALIZE_WARNING_LABEL, i + 36, 82, 114, 0);
            ...
            for(ExtendedBookEditInput.LineInfo ExtendedBookEditInput$lineinfo : ExtendedBookEditInput$displaycache.lines) {
    ...
    private void renderCursor(PoseStack p_98109_, ExtendedBookEditInput.Pos2i p_98110_, boolean p_98111_) {
    ...
    private ExtendedBookEditInput.Pos2i convertScreenToLocal(ExtendedBookEditInput.Pos2i p_98115_) {
        return new ExtendedBookEditInput.Pos2i(p_98115_.x - (this.width - 192) / 2 - 36, p_98115_.y - 32);
    }

    private ExtendedBookEditInput.Pos2i convertLocalToScreen(ExtendedBookEditInput.Pos2i p_98146_) {
        return new ExtendedBookEditInput.Pos2i(p_98146_.x + (this.width - 192) / 2 + 36, p_98146_.y + 32);
    }
    ...
    public boolean mouseClicked(double p_98088_, double p_98089_, int p_98090_) {
        if (super.mouseClicked(p_98088_, p_98089_, p_98090_)) {
            ...
            if (p_98090_ == 0) {
                ...
                ExtendedBookEditInput.DisplayCache ExtendedBookEditInput$displaycache = this.getDisplayCache();
                int j = ExtendedBookEditInput$displaycache.getIndexAtPosition(this.font, this.convertScreenToLocal(new ExtendedBookEditInput.Pos2i((int)p_98088_, (int)p_98089_)));
                if (j >= 0) {
    ...
    public boolean mouseDragged(double p_98092_, double p_98093_, int p_98094_, double p_98095_, double p_98096_) {
        if (super.mouseDragged(p_98092_, p_98093_, p_98094_, p_98095_, p_98096_)) {
            ...
            if (p_98094_ == 0) {
                ExtendedBookEditInput.DisplayCache ExtendedBookEditInput$displaycache = this.getDisplayCache();
                int i = ExtendedBookEditInput$displaycache.getIndexAtPosition(this.font, this.convertScreenToLocal(new ExtendedBookEditInput.Pos2i((int)p_98092_, (int)p_98093_)));
    ...
    private ExtendedBookEditInput.DisplayCache getDisplayCache() {
    ...
    private ExtendedBookEditInput.DisplayCache rebuildDisplayCache() {
        String s = this.getCurrentPageText();
        if (s.isEmpty()) {
            return ExtendedBookEditInput.DisplayCache.EMPTY;
        } else {
            int i = this.pageEdit.getCursorPos();
            int j = this.pageEdit.getSelectionPos();
            IntList intlist = new IntArrayList();
            List<ExtendedBookEditInput.LineInfo> list = Lists.newArrayList();
            MutableInt mutableint = new MutableInt();
            MutableBoolean mutableboolean = new MutableBoolean();
            StringSplitter stringsplitter = this.font.getSplitter();
            stringsplitter.splitLines(s, 114, Style.EMPTY.withColor(ChatFormatting.WHITE), true, (p_98132_, p_98133_, p_98134_) -> {
                int k3 = mutableint.getAndIncrement();
                String s2 = s.substring(p_98133_, p_98134_);
                mutableboolean.setValue(s2.endsWith("\n"));
                String s3 = StringUtils.stripEnd(s2, " \n");
                int l3 = k3 * 9;
                ExtendedBookEditInput.Pos2i ExtendedBookEditInput$pos2i1 = this.convertLocalToScreen(new ExtendedBookEditInput.Pos2i(0, l3));
                intlist.add(p_98133_);
                list.add(new ExtendedBookEditInput.LineInfo(p_98132_, s3, ExtendedBookEditInput$pos2i1.x, ExtendedBookEditInput$pos2i1.y));
            });
            int[] aint = intlist.toIntArray();
            boolean flag = i == s.length();
            ExtendedBookEditInput.Pos2i ExtendedBookEditInput$pos2i;
            if (flag && mutableboolean.isTrue()) {
                ExtendedBookEditInput$pos2i = new ExtendedBookEditInput.Pos2i(0, list.size() * 9);
            } else {
                int k = findLineFromPos(aint, i);
                int l = this.font.width(s.substring(aint[k], i));
                ExtendedBookEditInput$pos2i = new ExtendedBookEditInput.Pos2i(l, k * 9);
            }
            ...
            if (i != j) {
                ...
                if (j1 == k1) {
                    ...
                    for(int j3 = j1 + 1; j3 < k1; ++j3) {
                        ...
                        list1.add(this.createSelection(new ExtendedBookEditInput.Pos2i(0, j2), new ExtendedBookEditInput.Pos2i(k2, j2 + 9)));
                    }
            ...
            return new ExtendedBookEditInput.DisplayCache(s, ExtendedBookEditInput$pos2i, flag, aint, list.toArray(new ExtendedBookEditInput.LineInfo[0]), list1.toArray(new Rect2i[0]));
        }
    }
    ...
    private Rect2i createPartialLineSelection(String p_98120_, StringSplitter p_98121_, int p_98122_, int p_98123_, int p_98124_, int p_98125_) {
        ...
        ExtendedBookEditInput.Pos2i ExtendedBookEditInput$pos2i = new ExtendedBookEditInput.Pos2i((int)p_98121_.stringWidth(s), p_98124_);
        ExtendedBookEditInput.Pos2i ExtendedBookEditInput$pos2i1 = new ExtendedBookEditInput.Pos2i((int)p_98121_.stringWidth(s1), p_98124_ + 9);
        return this.createSelection(ExtendedBookEditInput$pos2i, ExtendedBookEditInput$pos2i1);
    }

    private Rect2i createSelection(ExtendedBookEditInput.Pos2i p_98117_, ExtendedBookEditInput.Pos2i p_98118_) {
        ExtendedBookEditInput.Pos2i ExtendedBookEditInput$pos2i = this.convertLocalToScreen(p_98117_);
        ExtendedBookEditInput.Pos2i ExtendedBookEditInput$pos2i1 = this.convertLocalToScreen(p_98118_);
    ...
    static class DisplayCache {
        static final ExtendedBookEditInput.DisplayCache EMPTY = new ExtendedBookEditInput.DisplayCache("", new ExtendedBookEditInput.Pos2i(0, 0), true, new int[]{0}, new ExtendedBookEditInput.LineInfo[]{new ExtendedBookEditInput.LineInfo(Style.EMPTY, "", 0, 0)}, new Rect2i[0]);
        private final String fullText;
        final ExtendedBookEditInput.Pos2i cursor;
        final boolean cursorAtEnd;
        private final int[] lineStarts;
        final ExtendedBookEditInput.LineInfo[] lines;
        final Rect2i[] selection;

        public DisplayCache(String p_98201_, ExtendedBookEditInput.Pos2i p_98202_, boolean p_98203_, int[] p_98204_, ExtendedBookEditInput.LineInfo[] p_98205_, Rect2i[] p_98206_) {
        ...
        public int getIndexAtPosition(Font p_98214_, ExtendedBookEditInput.Pos2i p_98215_) {
            int i = p_98215_.y / 9;
            if (i < 0) {
                return 0;
                ...
                ExtendedBookEditInput.LineInfo ExtendedBookEditInput$lineinfo = this.lines[i];
        ...
        public int changeLine(int p_98211_, int p_98212_) {
            int i = ExtendedBookEditInput.findLineFromPos(this.lineStarts, p_98211_);
            int j = i + p_98212_;
            int k;
        ...
        public int findLineStart(int p_98209_) {
            int i = ExtendedBookEditInput.findLineFromPos(this.lineStarts, p_98209_);
            return this.lineStarts[i];
        }

        public int findLineEnd(int p_98219_) {
            int i = ExtendedBookEditInput.findLineFromPos(this.lineStarts, p_98219_);

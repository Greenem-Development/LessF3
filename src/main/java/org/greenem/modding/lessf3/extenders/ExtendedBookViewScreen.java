...
public class ExtendedBookViewScreen extends Screen {
    ...
    public static final ExtendedBookViewScreen.BookAccess EMPTY_ACCESS = new ExtendedBookViewScreen.BookAccess() {
    ...
    private ExtendedBookViewScreen.BookAccess bookAccess;
    ...
    public ExtendedBookViewScreen(ExtendedBookViewScreen.BookAccess p_98264_) {
        this(p_98264_, true);
    }

    public ExtendedBookViewScreen() {
        this(EMPTY_ACCESS, false);
    }

    private ExtendedBookViewScreen(ExtendedBookViewScreen.BookAccess p_98266_, boolean p_98267_) {
        super(NarratorChatListener.NO_TITLE);
        this.bookAccess = p_98266_;
        this.playTurnSound = p_98267_;
    }

    public void setBookAccess(ExtendedBookViewScreen.BookAccess p_98289_) {
    ...
    public interface BookAccess {
        ...
        static ExtendedBookViewScreen.BookAccess fromItem(ItemStack p_98309_) {
            if (p_98309_.is(Items.WRITTEN_BOOK)) {
                return new ExtendedBookViewScreen.WrittenBookAccess(p_98309_);
            } else {
                return (ExtendedBookViewScreen.BookAccess)(p_98309_.is(Items.WRITABLE_BOOK) ? new ExtendedBookViewScreen.WritableBookAccess(p_98309_) : ExtendedBookViewScreen.EMPTY_ACCESS);
            }
        }
    }

    @OnlyIn(Dist.CLIENT)
    public static class WritableBookAccess implements ExtendedBookViewScreen.BookAccess {
        ...
        private static List<String> readPages(ItemStack p_98319_) {
            ...
            return (List<String>)(compoundtag != null ? ExtendedBookViewScreen.loadPages(compoundtag) : ImmutableList.of());
        }
    ...
    @OnlyIn(Dist.CLIENT)
    public static class WrittenBookAccess implements ExtendedBookViewScreen.BookAccess {
        private final List<String> pages;
        ...
        private static List<String> readPages(ItemStack p_98327_) {
            ...
            return (List<String>)(compoundtag != null && WrittenBookItem.makeSureTagIsValid(compoundtag) ? ExtendedBookViewScreen.loadPages(compoundtag) : ImmutableList.of(Component.Serializer.toJson((new TranslatableComponent("book.invalid.tag")).withStyle(ChatFormatting.DARK_RED))));
        }
